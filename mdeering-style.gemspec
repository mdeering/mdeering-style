...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{My perfered style and linter configurations}
  spec.description   = %q{My opinionated and even sometimes misinformed style and code linting configurations}
